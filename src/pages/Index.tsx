        ...
        <div className="absolute right-0 top-16 bottom-0 w-1/2 hidden lg:flex items-center justify-center">
          <div className="bg-white shadow-2xl" style={{ padding: "20px 20px 60px 20px", maxWidth: "460px", width: "90%" }}>
            ...
            <div className="text-center" style={{ paddingTop: "16px" }}>
              <p className="font-cormorant text-ink/70 text-sm leading-relaxed" style={{ letterSpacing: "0.05em" }}>
                Академический рисунок карандашом<br />
                <span className="text-xs text-graphite font-ibm font-light">натюрморт · штудия · построение формы</span>
              </p>
            </div>
          </div>
        </div>
